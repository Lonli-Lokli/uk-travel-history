        ...
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-8">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
            ...
            <section>
              ...
              <p>
                By accessing and using UK Travel History Parser (&quot;the Service&quot;), you accept and agree
            ...
            <section>
              ...
              <p>
                The Service is provided as a tool to help individuals track their UK travel history
                and calculate days outside the UK. You agree to:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Use the Service for lawful purposes only</li>
                <li>Not attempt to gain unauthorized access to any part of the Service</li>
                <li>Not use the Service in any way that could damage, disable, or impair it</li>
                <li>Verify all calculations independently before making immigration decisions</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL THE SERVICE PROVIDERS
            ...
            <section>
              ...
              <p>
                We are committed to protecting your privacy. All data processing happens locally
                in your browser. We do not collect, store, or transmit your travel history data
                unless you explicitly use cloud backup features (when available).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-slate-600 bg-amber-50 border border-amber-200 rounded p-4">
                <strong>Important:</strong> This Service does not provide legal advice. The calculations
                and information provided are for informational purposes only. You should always consult
                with a qualified immigration lawyer or advisor for guidance specific to your situation.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                authentication providers, etc.). Your use of such services is subject to their
