import { UIIcon, Button } from '@uth/ui';
...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Learn more about UK Travel History Parser and how it helps track your UK residency and travel days.',
};
    ...
    <PageWrapper variant="default">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
        <section>
          ...
          <p>
            UK Travel History Parser is a free, privacy-focused tool designed to
            help individuals track their UK travel history and calculate days
            spent outside the UK for immigration and residency purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Parse UK Home Office Subject Access Request (SAR) PDF documents
            </li>
        ...
        <section>
          ...
          <p>
            Your privacy is important. All data processing happens in your
            browser. Your travel history and personal information are not
            uploaded to any server unless you explicitly choose to use cloud
        ...
        <section>
          ...
          <p className="text-sm text-slate-600 bg-amber-50 border border-amber-200 rounded p-4">
            This tool is provided for informational purposes only and should not
            be considered as legal advice. Always verify your calculations and
            consult with an immigration lawyer or advisor for official guidance
            regarding your visa or residency status.
          </p>
        </section>
