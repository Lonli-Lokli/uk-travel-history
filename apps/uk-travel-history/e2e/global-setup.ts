...
async function globalSetup() {
  ...
  fs.writeFileSync(
    ...
    '# Accessibility Reports\n\n' +
      ...
      'Report format:\n' +
      '- `no-violations.md` - Generated when all tests pass (lists all devices tested)\n' +
      '- `SUMMARY.md` + rule-based files (e.g., `color-contrast.md`) - Generated when violations found\n\n' +
      'Each rule file shows which devices/browsers have that specific violation.\n',
    'utf-8',
  );
